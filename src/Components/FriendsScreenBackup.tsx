...
//   import { getUsersInitiate } from '../Redux/actions';
...
//           actions: [
//             // {
//             //   title: data.notificaiton+' <b>Dance</b> &#128111;',
//             //   pressAction: { id: 'dance' },
//             // },
//             // {
//             //   title: data.notificaiton + ' <p style="color: #f44336;"><b>Cry</b> &#128557;</p>',
//             //   pressAction: { id: 'cry' },
//             // },
//           ],
//         },
...
//       tempUserData = [];
//       setModalData(item);
//       tempUserData = await firestore()
//         .collection('users')
//         .doc(item._data.id)
//         .get()
//         .then(snapshot => {
//           tempUserData = snapshot._data;
//           setOtherUserProfileImage(snapshot._data.profileImage);
//           setOtherUserName(snapshot._data.name);
//           setOtherUserAge(snapshot._data.age);
//           setOtherUserPhotos(snapshot._data.photos);
//           setOtherUserInterests(snapshot._data.interest);
//           setOtherUserAbout(snapshot._data.about);
//           setOtherUserRelationshipStatus(snapshot._data.relationshipStatus);
//           setOtherUserFollowersList(snapshot._data.followers);
//           setOtherUserFollowers(snapshot._data.followers.length);
//           setOtherUserFollowing(snapshot._data.following.length);
//           setOtherUserEventsPosted(snapshot._data.eventsPosted);
//           setOtherUserUserId(snapshot._data.id.toString());
//           setOtherUserEducation(snapshot._data.education);
//           setOtherUserWork(snapshot._data.work);
//           setShowOtherUserInfoModal(true);
//           console.log('Other user userID ::' + otherUserUserId);
//           console.log('Other user Photos ::' + otherUserPhotos);
...
//         if (item3 == item._data.id) {
//           firestore()
//             .collection('users')
//             .doc(auth().currentUser?.uid)
//             .update({
//               following: firestore.FieldValue.arrayRemove(
//                 item._data.id.toString(),
//               ),
//             })
//             .then(res => {})
//             .catch(error => {
//               console.log(error);
//             });
//           console.log('DDDDDDDDDDDDDDDDDDDDDDDelete::' + item._data.id);
//           Alert.alert('You have unfollowed ' + item._data.name);
//         }
...
//               });
//             console.log(
//               'UUUUUUUUUUUUUUion 2nd array::' + item._data.id.toString(),
//             );
...
//                 item._data.fcmToken.toString(),
//             );
//           } else if (item2 === item._data.id) {
...
//           .doc(auth().currentUser?.uid)
//           .update({
//             following: firestore.FieldValue.arrayUnion(item._data.id.toString()),
//           })
//           .then(res => {
...
//             console.log(error);
//           });
//         console.log('UUUUUUUUUUUUUUion 2nd array::' + item._data.id.toString());
//         // Alert.alert("You are now following " + item._data.name);
//       }
//       Alert.alert('You are now following ' + item._data.name);
...
//               </TouchableOpacity> */}
//             </View>
//             {/* <Text style={[styles.heading, { marginTop: 70, marginLeft: 30 }]}><HTMLView
...
//             {/* <View style={{
//                           justifyContent: 'center', alignItems: 'center',
//                           borderWidth: 1, width: 50, height: 50, borderRadius: 25,
//                           // marginTop: 70
//                       }}>
