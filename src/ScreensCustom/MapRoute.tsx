...
const MapRoute = () => { //{originDataLat,originDataLong, destinationDataLat, destinationDataLong}
  ...
  console.log('origin long '+ route.params.userLat)
  console.log('origin long '+ route.params.userLong)


  const originLoc = {
    latitude : route.params.userLat,
    longitude : route.params.userLong,
  }
  ...
  // if(getView && getViewOrigin){
    // mapRef.current?.fitToSuppliedMarkers(["originLoc", "destinationLoc"],{
...
//   }
   }, [updateState, originLoc, destinationLoc])//updateState
  return (
    ...
    ref={mapRef}
      ...
      onMapLoaded={()=>setUpdateState(true)}
