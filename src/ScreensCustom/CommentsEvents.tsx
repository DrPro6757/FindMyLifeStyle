...
import { BASE_URL, DELETE_EVENT_POST_COMMENT, Get_EVENT_POST_COMMENTS, POST_EVENT_COMMENT } from '../Utils/Strings';
...
const CommentsEvents = () => {
    ...
    const GetAllComments = () => {
        axios.get(BASE_URL + Get_EVENT_POST_COMMENTS + route.params.id)
            .then((res) => {
    ...
    const deleteComment = () => {
        ...
        axios.delete(BASE_URL + DELETE_EVENT_POST_COMMENT + selectedCommentId)
            .then((res) => {
    ...
    const PostComment = () => {
        ...
        axios.post(BASE_URL + POST_EVENT_COMMENT, postEventData)
            .then((res) => {
